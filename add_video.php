...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
    ...
    $insert_query = "INSERT INTO videos (title, video, description, uploader, timestamp) VALUES (?, ?, ?, ?, ?)";
    ...
    // Bind parameters
    $stmt->bind_param("sssss", $video_title, $video_link, $video_description, $uploader, $timestamp);
                ...
                <div class="col-md-4 offset-md-4 form">
                  <form action="add_video.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Video Title" name="video_title" autocomplete="off" required>
                    </div>
                    <div class="form-group">
                        <label for="">Video Description:</label>
                        <input type="text" class="form-control" placeholder="Enter Video Description" name="video_description" autocomplete="off" required>
                    </div>
                    <div class="form-group">
                        <label for="">Youtube Video Link:</label>
                        <input type="text" class="form-control" placeholder="Enter Youtube Video Link" name="add_video" autocomplete="off" required>
                    </div>
                    <?php
