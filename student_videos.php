              ...
              <div class="row">
                ...
                ?>
                  <div class="col-md-6 col-lg-4">
                    <div class="card mb-4 box-shadow custom-card">
                      <!-- Image placeholder for the video -->
                      <a href="<?php echo $youtube_link; ?>" class="card-link">
...
<script>
    // Add event listener to all card links
    document.querySelectorAll('.card-link').forEach(function(cardLink) {
      cardLink.addEventListener('click', function(event) {
        event.preventDefault(); // Prevent the default link behavior

        // Get the YouTube video URL from the card link's href attribute
        var youtubeLink = cardLink.getAttribute('href');
